...
const LISTING_DATA = [
  ...
  { title: 'Almond milk 1L (unopened)', description: 'Oatly oat milk, bought wrong type. Unopened. Great for coffee or cereal.', categories: ['Beverages'], dietary_tags: ['Vegan', 'Gluten-free', 'Nut-free'],     photos: ['images/almond-milk-carton.png'], original_price: 7.00, listing_price: 2.00 },
  { title: 'Frozen peas 500g', description: 'Birdseye, straight from freezer. Pick up quick! Must stay frozen during transport.', categories: ['Other'], dietary_tags: ['Vegan', 'Halal', 'Gluten-free'],     photos: ['images/frozen-peas-and-carrots-bag.png'], original_price: 3.00, listing_price: 0 },
  { title: 'Kellogg\'s cornflakes (large box)', description: 'Bought 2 by accident, giving away the extra. Unopened, 750g box. Expires in 3 months.', categories: ['Snacks'], dietary_tags: ['Vegetarian', 'Gluten-free'],     photos: ['images/cornflakes-box.png'], original_price: 8.00, listing_price: 0 },
  { title: 'Labneh tub 400g', description: 'Original Kiri labneh, not opened. Great with zaatar and olive oil.', categories: ['Dairy'], dietary_tags: ['Vegetarian', 'Halal', 'Gluten-free'],     photos: ['images/labneh.png'], original_price: 5.00, listing_price: 0 },
  { title: 'Canned tomatoes × 6', description: 'Mutti brand. Bought in bulk for a party that got cancelled. Perfect for sauces and soups.', categories: ['Canned goods'], dietary_tags: ['Vegan', 'Halal', 'Gluten-free', 'Nut-free'],     photos: ['images/canned-tomatoes.png'], original_price: 9.00, listing_price: 0 },
  { title: 'Organic granola 500g', description: 'Jordans Country Crisp, sealed, expires next month. Full of oats, nuts, and honey clusters.', categories: ['Snacks'], dietary_tags: ['Vegetarian'],     photos: ['images/granola-bag.png'], original_price: 12.00, listing_price: 3.00 },
  { title: 'Hummus tub 200g (sealed)', description: 'Supermarket brand, sealed. Best before tomorrow — please pick up today if possible!', categories: ['Canned goods'], dietary_tags: ['Vegan', 'Halal', 'Gluten-free'],     photos: ['images/hummus-tub-sealed.png'], original_price: 3.50, listing_price: 0 },
  { title: 'Bottled smoothies × 8 (unsold)', description: 'Today\'s batch, never opened, cold pressed mango-ginger. Made fresh this morning at the café.', categories: ['Beverages'], dietary_tags: ['Vegan', 'Halal', 'Gluten-free', 'Nut-free'],     photos: ['images/bottled-smoothie.png'], original_price: 24.00, listing_price: 5.00 },
  { title: 'Sliced red peppers (sealed container)', description: 'Pre-sliced red peppers in a sealed plastic container. Perfect for stir-fry or salads. Picked up from Spinneys today.', categories: ['Other'], dietary_tags: ['Vegan', 'Halal', 'Gluten-free', 'Nut-free'],     photos: ['images/sliced-red-peppers.jpg'], original_price: 4.00, listing_price: 0 },
